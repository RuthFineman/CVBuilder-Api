    ...
    public partial class basis : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Education", x => new { x.FileCVId, x.Id });
                    table.ForeignKey(
                        name: "FK_Education_FileCVs_FileCVId",
                        column: x => x.FileCVId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Language", x => new { x.FileCVId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkExperience", x => new { x.FileCVId, x.Id });
                    table.ForeignKey(
